...
parser.add_argument("--data_path", type=str, default='/mnt/nfs/wbzhang/data/celltype_annotation/lung/1/data/scbert/', help='Path of data for finetune.')
parser.add_argument("--model_path", type=str, default='/mnt/nfs/wbzhang/scbert-master/panglao_pretrained.pth', help='Path of pretrained model.')
parser.add_argument("--ckpt_dir", type=str, default='/mnt/nfs/wbzhang/data/celltype_annotation/lung/1/Model/scbert/', help='Directory of checkpoint to save.')
parser.add_argument("--model_name", type=str, default='finetune', help='Finetuned model name.')
parser.add_argument("--fold_number", type=int, default=0, help='The number of 5 fold validation')
...
ckpt_dir = args.ckpt_dir + str(fold_number) + '_fold/'
...
# important  /4fold_train.h5ad
fold_path = args.data_path + str(fold_number) + 'fold' + '_train.h5ad'
data = sc.read_h5ad(fold_path)
# 有修改
#data = data[data.obs['cell_type'] != 'MHC class II']
...
print('The length of train:', len(train_dataset))
print('The length of val:', len(val_dataset))
...
for i in range(1, EPOCHS+1):
    ...
    if i % VALIDATE_EVERY == 0:
        ...
        with torch.no_grad():
            ...
            if if_print:
                print(f'    ==  Epoch: {i} | Validation Loss: {val_loss:.6f} | F1 Score: {f1:.6f} | Accuracy: {cur_acc:6.4f}%  ==')
