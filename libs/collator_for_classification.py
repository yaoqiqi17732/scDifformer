...
class PrecollatorForGeneAndCellClassification(SpecialTokensMixin):
    ...
    def save_pretrained(self, save_directory: str, **kwargs):
        """
        Save the tokenizer-like configuration to a directory.
        Since token_dictionary is static, we can just pass or save minimal info if needed.
        """
        import os
        import json
        ...
        config = {
            ...
            "token_dictionary": {k: v for k, v in token_dictionary.items()},
        }
